    ...
    children: [
      ...
      },
      {
        tabulated: {
          ...
          align: 'left',
          field: row => `${row.material_supplier.document_number}-${row.material_supplier.name}`,
          sortable: true,
          visible: true,
          visibleColumn: true
        },
      ...
      },
      {
        tabulated: {
          name: 'client',
          align: 'left',
          field: row => `${row.client.document_number}-${row.client.name}`,
          sortable: true,
          visible: true,
          visibleColumn: true
        },
      ...
      },
      {
        tabulated: {
          name: 'driver_name',
          align: 'left',
          field: row => `${row.driver_document_number}-${row.driver_name}`,
          sortable: true,
          visible: true,
          visibleColumn: true
        },
      ...
      },
      {
        tabulated: {
          name: 'deadline',
          align: 'left',
          field: row => date.formatDate(row.deadline, 'DD/MM/YYYY'),
          sortable: true,
          visible: true,
          visibleColumn: true
        },
      ...
      },
      {
        tabulated: {
          name: 'vehicle_brand',
          align: 'left',
          field: row => row.vehicle_brand,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'vehicle_brand',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
      ...
      },
      {
        tabulated: {
          name: 'vehicle_model',
          align: 'left',
          field: row => row.vehicle_model,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'vehicle_model',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
      ...
      },
      {
        tabulated: {
          name: 'vehicle_plate',
          align: 'left',
          field: row => row.vehicle_plate,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'vehicle_plate',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
      ...
      },
      {
        tabulated: {
          name: 'trailer_model',
          align: 'left',
          field: row => row.trailer_model,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'trailer_model',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
      ...
      },
      {
        tabulated: {
          name: 'trailer_plate',
          align: 'left',
          field: row => row.trailer_plate,
          sortable: true,
          visible: true
        },
        actionable: {
          propTag: 'trailer_plate',
          addible: true,
          editable: true,
          type: 'String',
          visibleLabel: true,
