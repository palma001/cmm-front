...
export default {
  ...
  modules: {
    ...
    accountingSeat: 'Asiento contable',
  ...
  creditNote: {
    ...
    typeOfCreditNotes: 'tipos de notas',
    voucher_type_note: 'tipos comprobante',
    type_of_credit_note: 'tipos de notas',
    created_at: 'fecha',
